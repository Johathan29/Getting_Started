...
function DocSidebarItemCategoryCollapsible({
  ...
  return (
    <li
      ...
      <div
        className={clsx('menu__list-item-collapsible hover:bg-transparent hover:text-[#4f9fff]', {
          'text-[#4f9fff]': isCurrentPage,
        })}>
        <Link
          className={clsx(styles.categoryLink, 'menu__link py-1', {
      ...
      <Collapsible lazy as="ul" className="menu__list pl-2" collapsed={collapsed}>
        <DocSidebarItems
          items={items}
